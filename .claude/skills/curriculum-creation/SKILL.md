...
5. **One section per session**, each with:
   ...
   - **Deep dive** — the second, deeper theory pass, taken after the hands-on tasks: mechanisms, trade-offs, edge cases, the "why" behind what was just built. Note where this should lead into further hands-on (more tasks, or extending the existing ones) rather than ending on theory alone.
